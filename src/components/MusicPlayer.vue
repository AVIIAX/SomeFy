<template>
  <div id="MusicPlayer"
    ...
    :style="{ borderTopColor: isOffline ? '#ff7575a8' : '#75ff83a8' }">
    <div class="flex items-center w-1/4">
      ...
      <div class="flex items-center ml-8">
        <button type="button">
          <noHeart v-if="!trackLiked" fillColor="#1BD760" :size="22"
        ...
        <Equalizer @click="isOpenEq = !isOpenEq" :class="isOpenEq ? 'text-[#282828]' : 'bg-black'"
          class="ml-4 cursor-pointer" :fillColor="isOpenEq ? '#ffffff96' : '#FFFFFF'" :size="18" />
      ...
      <div class="items-center justify-center" :style="{
        ...
        <div class="buttons flex items-center justify-center h-[30px]">
          ...
          <button class="p-1 rounded-full mx-3"
            ...
            <svg v-if="!isPlaying" xmlns="http://www.w3.org/2000/svg" :width="30" :height="30" viewBox="0 0 24 24"
              fill="#FFFFFF">
              <path :d="mdilPlay" />
            </svg>
            <svg v-else xmlns="http://www.w3.org/2000/svg" :width="30" :height="30" viewBox="0 0 24 24" fill="#FFFFFF">
              <path :d="mdilPause" />
            </svg>
          </button>
          ...
          <div class="mx-5 tooltip">
            <Snail class="slowedReverbed p-0" @click="useSong.toggleSlowedReverbEffect()" :style="{
              transform: useSong.isSlowed ? 'scale(1.1)' : 'scale(1)',
              color: useSong.isSlowed ? '#7de1ff' : '#ff6e6e9e'
            }" />
            <span class="tooltiptext" style="font-size: 12px;">Oneclick SlowedReverbed</span>
          </div>
